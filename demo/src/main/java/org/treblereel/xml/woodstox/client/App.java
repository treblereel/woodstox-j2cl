package org.treblereel.xml.woodstox.client;
...
public class App implements EntryPoint {
  ...
  public void onModuleLoad() {
    ...
    DomGlobal.document.body.appendChild(lines);    createXML();
    readXML();
  }
  ...
  private void readXML() {
    ...
    request.setOnReadyStateChange(xhr -> {
      if (xhr.getReadyState() == DONE) {
        GWT.log("? " + xhr.getResponseText());
        InputStream byteArrayInputStream = new ByteArrayInputStream(xhr.getResponseText().getBytes());
