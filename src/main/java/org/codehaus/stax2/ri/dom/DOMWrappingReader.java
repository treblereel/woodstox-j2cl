               ...
               XMLStreamConstants
{
    ...
    public QName getAttributeName(int index)
    {
        ...
        Attr attr = (Attr) _attrList.get(index);
        return _constructQName(attr.namespaceURI, _safeGetLocalName(attr), attr.prefix);
    }
    ...
    public String getAttributeNamespace(int index)
    {
        ...
        Attr attr = (Attr) _attrList.get(index);
        return _internNsURI(attr.namespaceURI);
    }
    ...
    public String getAttributePrefix(int index)
    {
        ...
        Attr attr = (Attr) _attrList.get(index);
        return _internName(attr.prefix);
    }
    ...
    public String getAttributeValue(String nsURI, String localName)
    {
        ...
        throw new UnsupportedOperationException("take a look at w3c.dom impl");
    ...
    public String getLocalName()
    {
        ...
        return _internName(_currNode.nodeName);
    }
    ...
    public QName getName()
    {
        ...
        return _constructQName(_currNode.namespaceURI, _safeGetLocalName(_currNode), _currNode.prefix);
    }
    ...
    public String getNamespaceURI() {
        ...
        return _internNsURI(_currNode.namespaceURI);
    }
    ...
    public String getPrefix() {
        ...
        return _internName(_currNode.prefix);
    }
    ...
    public boolean isAttributeSpecified(int index)
    {
        ...
        Element elem = (Element) _currNode;
        Attr attr = (Attr) elem.attributes.item(index);
        if (attr == null) {
            handleIllegalAttrIndex(index);
            return false;
        }
    ...
    public int next() throws XMLStreamException
    {
        ...
        case START_DOCUMENT: // initial state
             ...
             * with...
             */
            switch (_currNode.nodeType) {
            case 9:
            case 11:
                // For doc, fragment, need to find first child
                _currNode = _currNode.firstChild;
            ...
            default:
                throw new XMLStreamException("Internal error: unexpected DOM root node type "+_currNode.nodeType+" for node '"+_currNode+"'");
            }
            break;
        ...
        case START_ELEMENT: // element returned, need to traverse children, if any
            ...
            {
                Node firstChild = _currNode.firstChild;
        ...
        default:
             ...
             */
            {
                Node next = _currNode.nextSibling;
        ...
        case 6:
        case 12:
            throw new XMLStreamException("Internal error: unexpected DOM node type "+_currNode.nodeType+" (attr/entity/notation?), for node '"+_currNode+"'");

        default:
            throw new XMLStreamException("Internal error: unrecognized DOM node type "+_currNode.nodeType+", for node '"+_currNode+"'");
        }
        ...
        while (n != null) {
            ...
            if (attrs != null){
                for (int i = 0, len = attrs.getLength(); i < len; ++i) {
                    ...
                    String thisPrefix = attr.prefix;
                    if (thisPrefix == null || thisPrefix.length() == 0) { // nope
                        if (defaultNs && "xmlns".equals(attr.localName)) {
                            return attr.nodeValue;
                        }
                    } else if (!defaultNs && "xmlns".equals(thisPrefix)) {
                        if (prefix.equals(attr.localName)) {
                            return attr.nodeValue;
                        }
                    }
                }
        ...
        while (n != null) {
            ...
            for (int i = 0, len = attrs.getLength(); i < len; ++i) {
                ...
                if (thisPrefix == null || thisPrefix.length() == 0) {
                    if ("xmlns".equals(attr.localName) && namespaceURI.equals(attr.nodeValue)) {
                        return "";
                    }
                } else if ("xmlns".equals(thisPrefix)) {
                    if (namespaceURI.equals(attr.nodeValue)) {
        ...
        throws XMLStreamException
    {
        ...
        for (Node n = firstNode; n != null; n = n.nextSibling) {
            switch (n.nodeType) {
            case 1:
            ...
            case 4:
            case 3:
                _textBuffer.append(n.nodeValue);
                break;
            ...
            default:
                ...
                throwStreamException("Unexpected DOM node type ("+n.nodeType+") when trying to decode Typed content");
            }
        }
        return _textBuffer.get();
    }
    ...
    public int findAttributeIndex(String nsURI, String localName)
    {
        ...
        for (int i = 0, len = attrs.getLength(); i < len; ++i) {
            ...
            if (localName.equals(ln)) {
                String thisUri = attr.namespaceURI;
    ...
    public String getPrefixedName()
    {
        ...
        case END_ELEMENT:
            {
                String prefix = _currNode.prefix;
    ...
    public String getDTDRootName() {
        if (_currEvent == DTD) {
            return _internName(((DocumentType) _currNode).name);
        }
        return null;
    }
    ...
    public String getDTDPublicId() {
        if (_currEvent == DTD) {
            return ((DocumentType) _currNode).publicId;
        }
        return null;
    }
    ...
    public String getDTDSystemId() {
        if (_currEvent == DTD) {
            return ((DocumentType) _currNode).systemId;
        }
        return null;
    }
    ...
    {
        _textBuffer.reset();
        _textBuffer.append(_currNode.nodeValue);

        Node n;
        while ((n = _currNode.nextSibling) != null) {
            int type = n.nodeType;
    ...
    {
        NamedNodeMap attrsIn = _currNode.attributes;
        ...
        for (int i = 0; i < len; ++i) {
            ...
            if (prefix == null || prefix.length() == 0) { // nope
                // default ns decl?
                if (!"xmlns".equals(attr.localName)) { // nope
                    if (attrsToo) {
                        if (attrsOut == null) {
            ...
            nsOut.add(_internNsURI(attr.nodeValue));
        }
    ...
    private void handleIllegalAttrIndex(int index)
    {
        ...
        String msg = "Illegal attribute index "+index+"; element <"+elem.nodeName+"> has "+((len == 0) ? "no" : String.valueOf(len))+" attributes";
