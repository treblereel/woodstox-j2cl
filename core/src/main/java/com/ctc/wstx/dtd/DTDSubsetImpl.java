...
/*        throw new WstxParsingException
            (MessageFormat.format(ErrorConsts.ERR_DTD_NOTATION_REDEFD,
             ...
             newDecl.getLocation());*/
        throw new UnsupportedOperationException(new WstxParsingException("throwNotationException"));
    }
...
/*        throw new WstxParsingException
            (MessageFormat.format(ErrorConsts.ERR_DTD_ELEM_REDEFD,
             ...
             loc);*/
        throw new UnsupportedOperationException(new WstxParsingException("throwElementException"));
