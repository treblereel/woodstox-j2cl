...
public class RandomAccessFile  implements DataOutput, DataInput, Closeable {
	...
	@JsFunction
	public interface Fn {
		String onInvoke(String arg);
	}

	static String btoa(String s) {
		return Js.<Fn>uncheckedCast(Js.asPropertyMap(DomGlobal.window).get("btoa")).onInvoke(s);
	}

	static String atob (String s) {
		return Js.<Fn>uncheckedCast(Js.asPropertyMap(DomGlobal.window).get("atob")).onInvoke(s);
	}
